...
const InterviewCard = ({ interviewId, userId, role, type, techstack, createdAt }: InterviewCardProps) => {
  ...
  return (
    <div className='card-border w-[440px] max-sm:w-full min-h-96 '>
      <div className='card-interview'>
        <div className='absolute top-0 right-0 w-fit px-4 py-2 rounded-bl-lg bg-light-600'>
          <p className='badge-text'>{ normalisedType}</p>
        </div>

        <Image src={"/covers/adobe.png"} alt="cover image" height={90} width={90} className=" rounded-full object-fit size-[90px]" />
        <h3 className="mt-5">{role} Interview</h3>
        ...
        </p><div className="flex flex-row justify-between">
